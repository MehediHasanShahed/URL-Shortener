  ...
  return (
    <div className='flex flex-col items-center'>
      <h2 className='my-10 sm:my-16 text-3xl sm:text-6xl lg:text-7xl text-white text-center font-extrabold'>
        The only URL Shortener <br/> you&rsquo;ll ever need! ⬇️
      </h2>
      <form onSubmit={handleShorten} className='sm:h-14 flex flex-col sm:flex-row w-3/4 md:w-2/4 gap-2'>
      ...
      <img src='/banner.png' alt='URL Shortener Banner' className='w-full my-11 md:px-11'/>
